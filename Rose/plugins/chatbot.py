    ...
    if chat:
       await app.send_chat_action(message.chat.id, "typing")
        try:
           ...
           affiliateplus = requests.get(f"https://api.affiliateplus.xyz/api/chatbot?message={text}&botname=Isabella&ownername=@DarkRider2003&user={chat_id}")
           ...
           if "Lebyy_Dev" in textmsg:
               textmsg = textmsg.replace("Lebyy_Dev", "DarkRider")
